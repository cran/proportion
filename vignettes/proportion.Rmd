...
### 5.Metric 2:EXPECTED LENGTH (Applicable to Base, Adjusted and Continuity Corrected Methods)
...
### 6.Metric 3:p-CONFIDENCE, p-BIAS (BASE METHOD)
...
### 7.Metric 3:p-CONFIDENCE, p-BIAS (Applicable to Base, Adjusted and Continuity Corrected Methods)
...
### 8.Metric 4:ERROR (Applicable to Base, Adjusted and Continuity Corrected Methods)
...
### 9. EVALUATION METHODS FOR GENERAL APPROACH
...
### 10. Testing of hypothesis and other functions for Bayesian method 
...
### 11. Assistance for reading papers
...
# 17. Graph of the Confidence Interval of 6 base methods
...
```{r, echo=TRUE, results='asis'}
# 21. Confidence Interval of 6 base methods grouped by x (smallest at bottom for each group)
...
# 20. Hypothesis testing - Bayes Factor 4 
...
```{r, echo=TRUE, results='asis'}
# 21. Plot of ci of 6 adjusted methods with h=1
...
```{r, echo=TRUE, eval=FALSE}
# 22. ci using Excat method with range of e values including mid-p(0.5) and Cloper Pearson(e=1)
